...
from ftmcloud.api.domains.categories.services.category_services import CategoriesService
...
async def delete_category(pid: str):
    ...
    if len(child_categories) > 0:
        ...
        raise FtmException('exception.category.NotEmpty', developer_message=message, user_message=message)
