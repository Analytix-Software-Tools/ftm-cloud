...
class FtmException(Exception):
    ...
    def __init__(self, error_code: str, developer_message=None, user_message=None, exception=None,
        ...
        """
        Initialize the error with the specified error code. Load the errors
        YAML and attempt to parse the error. The details of the error are
        listed within the YML file.

        :param error_code: represents the application-specific code of the error
        ...
        with open('crosscutting/error/errors.yaml', "r") as stream:
            try:
    ...
    def __json__(self):
        ...
        Generates an HTTPResponse which is a JSON representation of the error to be
